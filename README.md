...
A cozy cafe-themed Pomodoro timer extension for Visual Studio Code designed to help developers stay focused and take mindful breaks.

## Features

* **Custom Study Goals:** Input your desired total study session duration (from 1 to 5 hours) right from your status bar prompt.
* **Continuous Classical Vibe:** Automatically triggers background classical music (`classical.mp3`) when focus starts, and loops it seamlessly to match the length of your study session.
...
3. Go to the Extensions view (`Ctrl+Shift+X` or `Cmd+Shift+X`), click the `...` menu at the top right, select **Install from VSIX...**, and choose your downloaded extension file.
